    ...
    <div class="max-w-lg mx-auto">
      <div class="flex items-center justify-around px-2 h-16 relative">
        ...
        <a href="<?= url('/index.php') ?>"
           class="relative flex flex-col items-center gap-1 px-3 py-2 rounded-xl transition-all duration-200
                  <?= $current_page === 'index' ? 'text-brand-400' : 'text-slate-500 hover:text-slate-300' ?>">
          <?php if ($current_page === 'index'): ?>
            <span class="absolute -top-0 left-1/2 -translate-x-1/2 w-5 h-0.5 rounded-full bg-brand-400"></span>
          <?php endif; ?>
        ...
        <a href="<?= url('/investments.php') ?>"
          ...
          <?php if ($current_page === 'investments'): ?>
            <span class="absolute -top-0 left-1/2 -translate-x-1/2 w-5 h-0.5 rounded-full bg-brand-400"></span>
          <?php endif; ?>
